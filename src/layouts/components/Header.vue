	...
	<header class="kt-header fixed top-0 z-10 start-0 end-0 flex items-stretch shrink-0 bg-background"
		...
		<div class="kt-container-fixed flex justify-between items-stretch lg:gap-4" id="headerContainer">
			...
			<div class="flex items-center gap-2.5">
				<!-- Logout Button -->
				<button
					class="group kt-btn kt-btn-ghost kt-btn-icon size-9 rounded-full bg-destructive/10 [&_i]:text-destructive"
					@click="logout">
					<i class="ki-filled ki-exit-right text-lg text-destructive">
					</i>
				</button>
				<!-- End of Logout -->
				<!-- Search -->
										...
										<div class="flex items-center gap-2.5">
											<div class="kt-card shadow-none flex flex-col gap-3.5 bg-muted/70 w-40">
												<div class="bg-cover bg-no-repeat kt-card-rounded-t shrink-0 h-24"
													style="background-image: url('/media/images/600x600/6.jpg')">
												</div>
											...
											<div class="kt-card shadow-none flex flex-col gap-3.5 bg-muted/70 w-40">
												<div class="bg-cover bg-no-repeat kt-card-rounded-t shrink-0 h-24"
													style="background-image: url('/media/images/600x600/1.jpg')">
												</div>
												<div class="px-2.5 pb-2">
													<a class="font-medium block text-secondary-foreground hover:text-primary text-xs leading-4 mb-0.5"
														href="#">
									...
									<ul class="kt-dropdown-menu-sub">
										...
										<li>
											<a class="kt-dropdown-menu-link"
												...
												<input class="ms-auto kt-switch" name="check" type="checkbox"
													value="1" />
											</a>
										</li>
									</ul>
